...
{
	[Authorize]    
	public class AccountController : TravelControllerBase
	{
		...
		{
			LayoutVm.InitPage("Login", "Sign in to " + layoutVm.WebsiteName, Nav.Login);
		...
		[Route("account/login", Name = "AttemptLogin")]
		public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
		{
			if (ModelState.IsValid)
			{
				...
				if (user != null)
				{
					...
					FlashMessage("Welcome back!", FlashMessageMode.Success);
		...
		[AllowAnonymous]
		[HttpGet]
		[Route("account/register", Name="RegisterForm")]
		public ActionResult Register()
		{
			LayoutVm.InitPage("Sign up ", "Join " + LayoutVm.WebsiteName, Nav.Register);
		...
		[AllowAnonymous]
		[ValidateAntiForgeryToken]
		[Route("register", Name = "AttemptRegister")]
		public async Task<ActionResult> Register(RegisterViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					...
					FlashMessage("Welcome to " + Properties.Settings.Default.WebsiteName,
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		[Route("logoff/account", Name = "LogOff")]
